...
public class EnumUtils {
    ...
    @NonNull
    public static <T extends Enum, U> Predicate<U> predicate(@NonNull Class<T> enumType, @NonNull Collection<T> input, @NonNull org.apache.commons.collections4.Transformer<T, Predicate<U>> transformer) {
